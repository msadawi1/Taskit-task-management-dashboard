        ...
        <>
            ...
            <Paper elevation={1} sx={{ p: 1.5 }}>
                <Grid container rowSpacing={1} columnSpacing={0.8} alignItems='center'>
                    <Grid size="auto">
                        <Checkbox icon={<RadioButtonUncheckedIcon />} checkedIcon={<CheckCircleIcon />} onChange={toggleCheck} checked={props.status} size="medium" variant='contained' color='primary' disableelevation="true" sx={{ fontWeight: "400", borderRadius: '50%', p: 0 }} />
                    </Grid>
            ...
            <FeedbackPopup open={popup} onClose={() => setPopup(false)}
                title={"Goal Already Completed!"} text={"You can’t uncheck this task because its goal has already been completed."}
                />
        </>
    );
}